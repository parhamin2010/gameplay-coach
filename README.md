...
An AI voiceover coach that watches your gameplay in real time and trash-talks you like that one friend who can't shut up. Never satisfied. Always blaming. Personally offended by every bad decision you make.
...
- Mic input is supported in code but disabled by default (ambient audio caused false triggers)
